    ...
    try:
        async with session.post(webhook_url, json=data) as response:
            if response.status == 204:
                print("\033[92mMessage envoyé avec succès !\033[0m")  # En vert
            else:
                print("\033[91mUne erreur s'est produite lors de l'envoi du message.\033[0m")  # En rouge
    except aiohttp.ClientError as e:
        print("\033[91mErreur de connexion :", e, "\033[0m")  # En rouge
    ...
    async def on_ready():
        ...
        if channel:
            try:
                ...
                print("\033[91mUne erreur s'est produite lors de l'envoi du message :\033[0m", e)  # En rouge
        else:
            print("\033[91mErreur : Salon Discord introuvable.\033[0m")  # En rouge
        await bot.close()

    try:
        await bot.start(token)
    except discord.LoginFailure as e:
        print("\033[91mErreur de connexion :\033[0m", e)  # En rouge
        ...
        for guild in bot.guilds:
            for channel in guild.channels:
                try:
                    ...
                    print("\033[92mSalon supprimé avec succès !\033[0m")  # En vert
                except discord.DiscordException as e:
                    print("\033[91mUne erreur s'est produite lors de la suppression du salon :\033[0m", e)  # En rouge
        await bot.close()
        ...
        for guild in bot.guilds:
            ...
            while True:
                try:
                    ...
                    print("\033[92mNouveau salon créé avec succès !\033[0m")  # En vert
                except discord.DiscordException as e:
                    print("\033[91mUne erreur s'est produite lors de la création du salon :\033[0m", e)  # En rouge
...
"""
    ...
    option = input("Voulez-vous utiliser un webhook ou un token de bot ? ([1] webhook/ [2] token) : ").strip().lower()
    clear_screen()
    print(logo)
    if option == "1":
